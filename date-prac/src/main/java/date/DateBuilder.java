...
public class DateBuilder {
    ...
    public void dateBuild() throws ParseException {
        ...
        System.out.println(new Date(1689775687682L)); // Wed Jul 19 22:08:07 CST 2023
        System.out.println(new Date(1689775687L)); // Tue Jan 20 21:22:55 CST 1970、 toEpochSecond和Date一起使用要注意
        System.out.println(new Date()); // Wed Jul 19 22:21:49 CST 2023
        ...
        System.out.println(Calendar.getInstance().getTime()); // Wed Jul 19 22:35:14 CST 2023
        ...
        System.out.println(DateUtils.parseDateStrictly("2019-07-07 20:18:18 +0800", "yyyy-MM-dd HH:mm:ss Z")); //Sun Jul 07 20:18:18 CST 2019
    ...
    public void instantBuild() {
        ...
        System.out.println(DATE.toInstant());//2019-07-07T12:18:18.888Z
    ...
    public void offsetDateTimeBuild() {
        // 2023-07-20T22:18:02执行代码
        System.out.println(OffsetDateTime.now());// 使用系统时区 2023-07-20T22:18:02.831578900+08:00
        System.out.println(OffsetDateTime.now(ZoneId.of("Asia/Tokyo")));//自己指定时区 2023-07-20T23:18:02.831578900+09:00
        System.out.println(OffsetDateTime.now(Clock.systemUTC()));//自己指定时区 2023-07-20T14:18:02.831578900Z
        System.out.println("----------1");
        ...
        System.out.println(OffsetDateTime.of(LOCAL_DATE_TIME, ZoneOffset.ofHours(8)));//2019-07-07T20:18:18.000000888+08:00
        ...
        System.out.println(OffsetDateTime.ofInstant(LOCAL_DATE_TIME.toInstant(ZoneOffset.ofHours(9)), ZoneOffset.ofHours(8)));//2019-07-07T19:18:18.000000888+08:00
        System.out.println("----------2");

        System.out.println(LOCAL_DATE_TIME.atOffset(ZoneOffset.ofHours(9)));//2019-07-07T20:18:18.000000888+09:00
        System.out.println(LOCAL_DATE_TIME.atOffset(ZoneOffset.ofHours(8)));//2019-07-07T20:18:18.000000888+08:00
    ...
    public void zonedDateTimeBuild() {
        // 2023-07-20T22:48:15执行
        System.out.println(ZonedDateTime.now());//使用系统时区 2023-07-20T22:48:15.845275700+08:00[Asia/Shanghai]
        System.out.println(ZonedDateTime.now(ZoneId.of("Asia/Tokyo")));//自己指定时区 2023-07-20T23:48:15.845275700+09:00[Asia/Tokyo]
        System.out.println(ZonedDateTime.now(Clock.systemUTC()));//自己指定时区 2023-07-20T14:48:15.845275700Z
        System.out.println("----------2");
        ...
        System.out.println(ZonedDateTime.parse("Sun Oct 01 00:00:00 EDT 2017", DateTimeFormatter.ofPattern("EEE MMM dd HH:mm:ss zzz yyyy").withLocale(Locale.US))); // 2017-10-01T00:00-04:00[America/New_York]
        System.out.println(ZonedDateTime.parse("Sun Oct 01 00:00:00 EDT 2017 GMT+0800", DateTimeFormatter.ofPattern("EEE MMM dd HH:mm:ss zzz yyyy 'GMT'Z").withLocale(Locale.US)));// 2017-09-30T12:00-04:00[America/New_York]
    }
}
