...
//            synchronized (object1) {
    ...
    public static void methodC() {
        try {
            ...
            synchronized (Synchronized_Class_ObjectService.class) {
                System.out.println("static methodC begin 线程名称:" + Thread.currentThread().getName() + " times:" + System.currentTimeMillis());
                for (int i = 1; i <= 5; i++) {
                    System.out.println("synchronized thread name:" + Thread.currentThread().getName() + "-->i=" + i);
                    Thread.sleep(1000);
                }
                System.out.println("static methodC end   线程名称:" + Thread.currentThread().getName() + " times:" + System.currentTimeMillis());
...
//            String object1 = new String();
//            synchronized (object1) {
            System.out.println("static methodD begin 线程名称:" + Thread.currentThread().getName() + " times:" + System.currentTimeMillis());
            for (int i = 1; i <= 5; i++) {
                System.out.println("synchronized thread name:" + Thread.currentThread().getName() + "-->i=" + i);
                Thread.sleep(1000);
            }
            System.out.println("static methodD end   线程名称:" + Thread.currentThread().getName() + " times:" + System.currentTimeMillis());
//            }
    ...
    public synchronized static void methodG() {
        try {
            ...
            System.out.println("static method begin 线程名称:" + Thread.currentThread().getName() + " times:" + System.currentTimeMillis());
            for (int i = 1; i <= 5; i++) {
                System.out.println("synchronized thread name:" + Thread.currentThread().getName() + "-->i=" + i);
                Thread.sleep(1000);
            }
            System.out.println("static method end   线程名称:" + Thread.currentThread().getName() + " times:" + System.currentTimeMillis());
