...
////        Synchronized_this_ThreadA a = new Synchronized_this_ThreadA(service2);
//        a.setName("A");
//        a.start();
...
//        b.start();
         ...
         * 1.synchronized (this)代码块则同步处理
         * 2.synchronized (this)代码块以外的代码异步处理
         */
        /**
         ...
         */
        /**
         *  多个线程访问同一个对象的2个不同方法，一个方法包含synchronized (this)部分，另一个为synchronized方法，则同步处理
         */
    }
}